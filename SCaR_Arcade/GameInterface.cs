        ...
        */
        ...
        private static void populateGameData()
        {
            if (gList == null)
            {
                ...
                gList.Add(new Game { gTitle = "Tower of Hanoi", gLogo = Resource.Drawable.game1, gMenuBackground = Resource.Drawable.game1bg, minDifficulty = 3, maxDifficulty = 8, gStart = new GameActivities.TowersOfHanoiActivity() });
